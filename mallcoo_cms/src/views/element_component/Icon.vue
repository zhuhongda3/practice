<template>
  <div>
    <card-box title="图标集合" toggle="false">
      <template slot="content">
        <ul>
          <li v-for="(item,index) in itemList" :key="index" title="点击复制" @click="handleCopy(item,$event)">
