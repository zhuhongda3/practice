<template>
  <div>
    ...
    <card-box title="可自适应文本高度的文本域">
      <template slot="content">
        <el-input
          type="textarea"
          autosize 
          v-model="textarea2"
          placeholder="请选择内容（行数自适应）">
        </el-input>
        <br>
        <el-input
          type="textarea" 
          ...
          v-model="textarea3"
          placeholder="请选择内容（最小2行，最大4行，超出出现滚动条）">
        </el-input>
      </template>
...
import {code1,code2,code3,code4,code5,code6} from '@/code/input';
